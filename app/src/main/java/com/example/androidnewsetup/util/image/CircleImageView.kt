package com.example.androidnewsetup.util.image
...
class CircleImageView : AppCompatImageView {
    ...
    private fun setup() {
        ...
        mBitmapShader = BitmapShader(mBitmap ?: return, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP)
        ...
        mBitmapHeight = (mBitmap ?: return).height
        mBitmapWidth = (mBitmap ?: return).width
    ...
    private fun updateShaderMatrix() {
        ...
        (mBitmapShader ?: return).setLocalMatrix(mShaderMatrix)
    }
